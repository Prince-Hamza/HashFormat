...
to anyone with enough gold, the land of Aelisus has become riddled with
...
with enough gold to pay for their traps, the land of Aelisus is riddled
...
Syntax: sheath		: sheathes your weapons if possible
  ...
  Any profession of Aelisus has ability to sheath their
...
The Imortals of Aelisus offer clan related commands to help those
...
ON SKILL SELECTION:
  ...
  Number of classes and races in Aelisus offer opportunity for the player
...
conduct in Aelisus. This list applies to ALL CABALS, without exception, and
...
Good characters believe in helping those in need, being kind, and protecting

those who cannot protect themselves. Some reject violence while others

fight against evil when necessary in order to protect themselves and others.

Law and lawlessness are secondary concerns to the overall good and most

Good characters follow some code of conduct to keep themselves accountable.

Goods who are overly bloodthirsty against neutrals will be reprimanded by

the Immortals of the realm and a Good character would never raise a hand

against a fellow Lightwalker, lest they incite the anger of the Gods.

 

Those within the guildhalls of the Paladins, Clerics, and Healers are most

expected to uphold these ideals. 

 

A Good can attack an Evil at any time without consequence.

A Good can attack a Neutral only when provoked or in a vendetta'd Cabal.

A Good can attack a Good only when the aggressor is of EMPIRE and the

defender is WANTED.

Healers may not be overly aggressive, except against Undead enemies.
...
Evil Characters selfishly and shamelessly live to exploit others for their

own advancement and power, heedless of the well-being of others. The truly

wicked even venture forth to spread suffering unto others for their own

amusement, or in service to their merciless gods. Evils will lend aid to

others only in proportion to what is received in return, for the helping

of others in growing stronger weakens oneself by comparison. No matter how

much they attempt to manipulate or control others, true evils strive to

become powerful in their own right and shun displaying weakness, for this

only invites aggression from their peers.

 

Those within the guildhalls of the Dark-Knights, Clerics, and Shamans are 

most expected to uphold these ideals.

 

Evils can attack anyone for any reason. The exception to this would be if

the aggressor is Lawful Evil and the defender is in town and -not- WANTED.
...
The Aelisus uses various automatic actions, to ease the boredom of
...
of choosing the #th type of a mobile or object by using Hash=|=|=.</mobile/object>.
...
#46
-1 gain 'hitgain' 'managain' 'movegain'~
HITGAIN MANAGAIN MOVEGAIN


These stats reflect how many of the chosen resource are restored per game

hour, which is roughly thirty seconds in real time.  Items that increase

hitgain, for example will increase the amount of HP you gain per hour. 

Skills or spells are able to reduce these gains as well in order to cause

hardship to an enemy.  Notable spells to reduce hitgain include plague and
...
Aelisus economy is based on gold coinage.  You may use gold to
...
enough.  Head out of the northern gate of  to find the forest.  In
...
When you consult your maps, you will see that Thalos lies east of 
...
have gained about the eighth rank, head back to  and travel out the
...
of .  To find them, travel out of the west gate to the great tree. 
...
While your first days in the Aelisus might seem very daunting
...
magic's that came together to forge the lands known as Aelisus, only 

that a once lifeless husk of rock in space was born under the warmth

of a sun.  From the dawn of its existence, Aelisus was a doomed land.
...
hellish netherworld, and took Aelisus for their own, executing
...
charactering is NOT allowed at the Aelisus.  Multi-character
...
Here at the Aelisus we ask our players to have a believable
...
Welcome to Aelisus.  This is a role-playing, player-killing mud.
...
The notes on Aelisus replace the bulletin boards and mail systems
...
respect.  Violence is a major part of daily life on Aelisus, and all
...
The Aelisus prompt has limited ability to be color-customized.
...
Role-playing is mandatory here at Aelisus.  Role-playing is 
...
makes Aelisus an interesting realm to live in.
...
syntax: quest
  ...
  Aelisus offers an advanced dynamic quest system.  More then 
...
The Aelisus are overseen by a group of beings who have been
...
Certain cabals in the Aelisus are known to pay for and organize raiding
...
During the Fourth Age of Aelisus when the armies of Chaos ravaged and 
...
Not soon after the foreboding rumors begun to arise in Aelisus. Newborns
...
Virigoth is the embodiment of death and decay in Aelisus, often deity of 
...
creation to continue. It holds power over all things of Aelisus that ceased 
...
common symbol around graveyards of Aelisus. Engraved for protection of the 
...
The Aelisus's calendar is divided into two time periods. B.C. and P.C. B.C.
...
the tides of chaos and death that haunt Aelisus.  A position that requires

strict discipline, diplomacy, and patience.  


Those of the royal houses of Aelisus are chosen by immortality to lead
...
"8|"#|""   "!AELISUS: The Aelisus - MESSAGE OF THE DAY (MOTD)""   "#|""
...
"8|"#|""          "!AELISUS: The Aelisus - IMMORTALS            "#|""
...
at the Aelisus has decided that you exemplify all of
...
as follows.
    ...
    c) Immortals are NEVER allowed to divulge information about
       ...
       the Aelisus to ANY other MUD. Immortals are NOT
...
These are the rules of the Aelisus.  The are made to make your
...
* Aelisus is a PG-13 MUD. Any form of intimitate sexual behavior 
...
#171
-1 DRUID DRUIDS~
Druids are the purest embodiment of nature.  They live to serve only the

balance and are perhaps some of the most ancient sages in Aelisus.  By

nature, Druids are communers, as they use the forest forces to cast their

own spells of protection and healing.  Furthermore, druids are a master of

herbs.  They have learned to brew potent concoctions and stomach them with

less fear of "&TOXICITY"" than the average adventurer.  

 

Druids are the predecessors of the modern ranger class, and while they have

many of the same combat abilities, they are much more aloof and clerical

than the fighting class of a ranger.  

 

As a Druid's home is within the forest, while he is away from the forest, he

will experience a painful "&YEARNING"".  

 

A druid will find his guild masters residing within a forest only, as druids

by nature dislike the population and the crowd of a city.  Most are rural

creatures and rarely emerge out of the woodlands.  

 

If you desire to join the druids' order, you must be of "&NEUTRAL"" alignment, a

cleric, and reach the twentieth title.  Inquire within the cleric guildhall

once you are ready-the mission-master will likely need your help.  
...
The Aelisus has the following races for player characters:
...
In addition to the above listed races, The Aelisus also gives you
...
races.  There are three different types of giants in Aelisus.


See Also: STORM, STONE, FIRE
...
Stone giants inhabit the wilderness of Aelisus, and live by using their brute
...
In the Fourth Age of Aelisus, the demon Shadowspawn came from the Chaos Rift

and tore Aelisus and its populace asunder with the screams and torments of

the Chaos Demons. These vile creatures were unlike any Aelisus had seen.
...
The Aelisus has the following classes
...
#198
-1 SHAMAN SHAMANS~
Shamans are dark priests who seek to destroy others' faith, often

becoming prophets of death and suffering.  Communing their powers from pain,

suffering, and their patron deity, they possess a devastating array of

maledictions with which to plague their enemies.  


An evil cleric may choose to follow the shaman's path when they have

achieved the twentieth rank.  When the time comes, they must speak with the

mission-master in their cleric guildhall.  
...
their gods to heal and protect themselves, as well as those around them.  


A healer's power extends to such a degree that only they of all classes can

reverse all effects of death upon a character, including loss of experience

and constitution through resurrection.  Furthermore, the presence of a

Healer in a group lends safety, as they will automatically attempt to save

any group member from death by pushing them out of the area and bravely

stopping the deathblow with their own flesh.  


A good cleric can choose the healer's path once they have achieved the

twentieth rank.  When the time comes, a cleric need only inquire with the

mission-master in their guild.  
...
General Tour of Jails of Aelisus:

  

  Aelisus includes a comprehensive Justice system used to 
...
In the first age of Aelisus the time of Bloodletting saw the great armies
...
any specific guild of Aelisus though they may join one at any time. 
...
After the utter destruction and recreation of Aelisus, the scholars of the
...
additions have been made into the lore of Aelisus, and they can be found
...
Gnomes are a race of small creatures living in the woodlands of Aelisus,
...
Aelisus's races.  Gnomes are a contemplative lot, thinking of this and
...
to use in combat.  Acting upon orders of the High King of Aelisus, the guild
...
of the single most expansive library in Aelisus, overshadowing even that of
...
rather liked and favored by noble Houses of Aelisus.
...
ANTIMAGIC
 ...
 A trap as ancient as the oldest profession of the Aelisus, it was developed
...
(An excerpt from a giant scroll that floated above Aelisus for three days)
...
Syntax:	sheath <obj>	: double sheathes
  ...
  Certain professions in Aelisus are trained in storing secondary
...
WEAPON EXPERTISE
  ...
  A select few professions of Aelisus are so focused and dependant on their
...
FIRED WEAPONS
  ...
  Some professions of Aelisus choose to focus and excel in use of
...
Stalking the cities of Aelisus at night, a Kindred is silent and deadly killer. 
...
Syntax: alias <alias> <commands>
 ...
 Aelisus features an easy to use alias system to allow you to setup
...
Because all creatures of Aelisus only have two hands, a person may
...
of the evil gods of Aelisus, thus breathing malicious spirit into the target item. 
...
HELP UNDEAD UNLIFE
   ...
   all Aelisus, with rebirth of Virigoth the ancient undead were
   ...
   telling of horrible beings seen on night roads of Aelisus.


   It is not without cause that the graveyards of Aelisus are 
   ...
   travel the roads at night fulfilling Its will in Aelisus.
...
Before the rise of guilds in Aelisus, the Eternal Army ruled the lands by
...
BEGINNINGS
  ...
  The Order of Crusades was first founded in the 5th age of Aelisus by a 
...
#732
-51 CRUSADER CRUSADERS~
CRUSADER


  Trained by the Order of Crusades these mighty men and women of the

One God, travel through Aelisus helping those in need, avenging
...
be equal, so must the lands of Aelisus. Darkness is balanced by Light, and
...
Neutrality. Four sides to a cube, and a Left to a Right. 
 ...
 Avariel, Spectrum of Balance, guards the delicate Scale that is Aelisus and
...
Avariel began to hear the cries of her children in Aelisus. Transcending time

and space, she emerged  high above in the Heavens of Aelisus. It is from here,
...
After many years of existence in the wilds of Aelisus the Barbarians
...
the heavens watching down upon Aelisus.  But what can be said about the Lord
...
GENERAL INFO.
  ...
  Aelisus posses a sophisticated voting system to allow members of various
...
Liars, cheaters, and stealers of Aelisus unite and rejoice, for there is
...
to life, and do their own part to reclaim Aelisus for the cause of Good.  
...
and save Aelisus in the process.  
...
the most powerful spells in Aelisus.  There are also those who focus upon
...
as those of the shadows walk Aelisus's soil, all need fear the night.  
...
If there is one thing that unites every being in Aelisus, it is the concept of
...
other gain extra recognition as the Master Questor of Aelisus.
...
lands of Aelisus, the skills to actual carry meaningful combat while
...
Syntax:  mount	 : mounts a rented or summoned creature (mounted affect)
  ...
  The land of Aelisus is large indeed, and many a sole has been
...
The Cabals of Aelisus are for the most part, player controlled, from
...
cities of Aelisus from dangers of crime are known as Sentinels of Justice. 
...
criminals, the Enforcer is most at home outside the cities of Aelisus and
...
#883
-1 Vaelinn~
Born a mortal in the second age of Aelisus, Vaelinn was a devout and

powerful cleric who fought to restore order and peace to Aelisus.  Towards the
...
The cabals of Aelisus have all developed various powers intrinsic 
...
that he arrived in Aelisus after Virigoth. Although both serving the
...
infamous and highly unreliable "Early history of Aelisus", first mentions a
...
of Aelisus, seeking their aid, but these events are unusual indeed.  Legend
...
#915
-1 NOBLE NOBILITY~
Aelisus is a place of intrigue and danger, yet not too far from the
...
towns and cities.  Each of the three city-states, , , and

Aelisus, may have up to 5 noble citizens to help rule.  The rest of the
...
There was such time in the history of Aelisus when the crime families of
...
crime world of Aelisus was transformed overnight.  The great crime families
...
the members of the greatest crime family in Aelisus to pass unharmed
...
underworld of AAelisus united under the banner of Syndicate
...
from every land in the AAelisus. Death has no effect on
...
Syntax: exile <victim>
  ...
  The Royals and Nobles of Aelisus hold the right and power to
...
Syntax: coup <victim>
  ...
  The more 'ambition' driven organizations in Aelisus allow
...
Syntax: diplomacy
  ...
  The Royal Houses of Aelisus have long perfected the art of
...
of Aelisus when the lands were free of the taint of Undead and Demonic
...
Houses of  and Aelisus and quickly formed an elite force of men and

women to counter this threat.  Called the Knights of the Crown, and guided by

the Royal Houses, they were Aelisus's last defense against the tides of 

darkness.

 

Yet seeing the House of  fickle in their loyalty and pursuit of

riches, and the House of Aelisus often allied with the dark powers the
...
rested the safety of Aelisus as they searched for the True King to once
...
Vanguards to forever battle the evils upon Aelisus.
...
of their ranks.  Those whom aspire to join them in service to Aelisus should
...
those whom seek to taint Aelisus will peace be brought to the land once more.
...
and foresight, their members watch over the lands of Aelisus for signs of
...
Aelisus uses a system of diplomatic pacts to simulate
...
- The room has a fortified  bastion, 1 normal garrison and 1 elite
...
Syntax: escort
 ...
 With only a simple order the nobility of Aelisus may summon their
...
Aelisus's soil, it still wages on.  But there has been no war so epic
...
this unholy threat, the city-states of , , and Aelisus
...
However, the ruler of the Aelisusian Throne, soon fell in league with
...
The City of , more intent on money and power, withdrew their troops
...
Nexus.  Bent on the eradication of Light, and the enslavement of Aelisus, they
...
SPECIAL TRAITS:  The hordes of Nexus enter Aelisus through unholy gates.
...
Bards are the jacks of all trades in Aelisus.  Dabbling in every
...
There is an ancient legend told in lands of Aelisus to the younglings, a
...
Aelisus was scarred and burnt when the final battles of the War of the
...
pools of knowledge, the populace of Aelisus dubbed these scholars SAVANTS.  
...
the corners of Aelisus to guard it's flow.  With the appearance of the Tower
...
webbing much like those of the large arachnids of Aelisus.  The webs
...
the great cities of Aelisus as focus for this ability, the 
...
Many different races of people call Aelisus home, but many more still have yet

to emerge from the hidden parts of the world.  

 

The Implementors of the Aelisus have given you the oppurtunity to apply
...
1)  You must have exceptional RP.  From the second you entered Aelisus, you have
...
Roleplaying is not merely required here at The Aelisus, it is enforced.
...
want to destroy every gnome in Aelisus, or save them all?
...
Among Aelisus's citizens, none are more dedicated to their own than those of
...
Two weeks the wisest and most experienced warriors in Aelisus spent
...
on the natural forces of Aelisus to aid the Stalker in their battles against
...
of countless warriors of Aelisus.  However few of them outside the
...
lesser denizens of Aelisus, but may aid them in ranking, gathering equipment,

and the like.  In their wisdom, the True Gods of Aelisus have also decreed
...
included in Library of Aelisus for others to read an enjoy.
...
Author:        Used to set the author of the tome.
...
scribe edit <#> <#> : Edit a given tome

scribe delete <#> <#> : Remove a given tome

scribe author_change <subject> <tome> <name> - changes the author on a tome that exists already

scribe delete_topic <subject #> : Deletes an entire topic.
...
The Libraries Of Aelisus house literary works of mortals and Immortals
...
While present in one of the Aelisus Libraries one may request for
...
the giant Ghorn, and entered the World of Aelisus as another Immortal. He has
...
Aelisus. He is very often characterized as a friendly and talkative man, but 
...
#1079
-1 'craft' 'crafting'~
Successful crafting in Aelisus comes down to attunement to and

acquisition of "&ESSENCE"", ownership of "&RECIPES"", and possession of "&MATERIALS"". 

There is currently only one crafting profession, which is "&COOKING"".  You can

learn cooking in any of the cities.  Even before acquiring a craft, you may

come across "&RECIPES"" in the world-for sale, from a corpse, or through

"&GATHERING"".  


To use your profession you simply must properly "&ATTUNE"" to prepare the effect

you wish, ensure you have the proper material(s), stand in front of your

particular "&CRAFTING STATION"", and use your "&CRAFTING SKILL"".  Your statistics

such as wisdom and intelligence, as well as your proficiency, will modify
...
#1080
-1 'ESSENCE' 'ESSENCES'~
Essence is the old world magic of Aelisus that has been tapped for

terrific properties long before the invader brought their new world powers. 

Essence exists in everything, living or otherwise.  This power can be

categorized in to four elemental properties, with two more being introduced

with the invasion of Sidr and Devortrix.  Ancient "&ESSENCE FORGES"", existing

long before even written word has been invented, have been claimed by each

city, though some still are hidden away in the wild.  While the ability to

tap the essence of living beings is still beyond the power of mortals,

essence forges make it possible to claim the power imbued on items found

throughout the world.  By building up your bank of essence, and "&ATTUNING""

properly, crafters can then refocus it to their will.  

~

#1081
-1 'essence forge' 'essence forges'~
Essence forges are located in "&CAELWYN"", "&ATHELN"", "&MUGGERS ALLEY"", and several

other places throughout the world.  You may put any item with inherent power

in to them and receive a fraction of the power the item has held back, in

the form of the element or elements that it represents.  For example, if the

item increased your health you will receive fire "&ESSENCE"".  The amount of

essence you have returned to you is directly related to the forge.  Common

forges return much less essence than forges in dangerous places.  Be aware

that the item will be destroyed in the process of extraction, and rarer

items will always give a greater boon than the more common ones due to their
...
world where he could travel and do as he pleased and so he stayed on Aelisus
...
born in  where he would live for the rest of his mortal life.  His
...
#1087
-1 'recipe' 'recipes' 'crafting recipe' 'crafting recipes'~
Syntax: recipe - Shows all learned recipes.  


Crafting recipes are learned through items bearing the prefix [RECIPE]. 

They are not normal recipes, however, but old world documentation on

infusing the power of "&ESSENCE"" in to products the crafter creates.  Though

the process can be complex, recipes can be memorized by simply using them. 

Recipes always call for one or more base "&MATERIALS"" and some essence of which

has been previously "&ATTUNED"" by the crafter.  
...
was that he was different, in many ways.  The voices of Aelisus were heard,
...
one day calming the ever present tide of darkness on Aelisus's surface.  Was
...
lawful citizens within Aelisus, the room in which Arther was formed will not
...
is his very existance.  As long as there is crime within Aelisus, Lord Arther
...
MEMORY SPELLS
  ...
  Though majority of classes in Aelisus require no memorization of spells
...
Lawful Good characters believe that peace and cooperation are to be 

preserved for the good of all. The honest hardworking citizen, the just

ruler, the genuinely good person.  Pacifists nearly always fall under 

this category though many lawful goods believe that dire situations 

warrant action. They believe that the laws of Justice are the best

way to achieve prosperity through peace and just laws. A Lawful good 

character would never break the law, even if they could get away with

it. Additionally, they would not allow crimes to occur without notifying
...
To do good for goodness' sake is the core tenet of a Neutral Good. Whether

this follows Justice law or not is irrelevant as long as the greater good

is always fulfilled. If an action would reduce or eliminate suffering, it

is sufficient for a Neutral Good regardless of the consequences. One 

situation might warrant breaking Justice law while another scenario would

warrant notifying the authorities as long as the final outcome is positive
...
Chaotic good characters follow a strong personal moral code and have little

regard for the rules of society. The core of this code must always be a

good heart and a strong sense of self-imposed justice. They are often kind

to those who are also good, and often hostile to rules and regulations that

would curtail their sense of justice and are often seen as vigilantes and

rebels. A Chaotic good character would not go out of their way to break

Justice law but would not see it as a hindrance or factor in their decision

making to achieve a greater good. They are individualists who seek to improve

society based on their own understanding of righteousness.
...
Lawful Neutral characters are governed by Order above all else. They

tend to have a strong personal code and use logic and tradition to keep

a necessary peace. Laws are important, not necessarily because every law

is the definition of perfection, but because law is the best way to maintain 

a consistent and fair society. Laws must be obeyed, not necessarily because

one agrees with each and every one, but because the benefits of Order outweigh

the price of lawlessness. If a law must be changed, it can be done through

the proper channels. A soldier, government employee, or city Merchant would

be examples of a Lawful Neutral. They would never break a law, as it goes 

against everything Lawful Neutral stands for, whether they are caught or not.
...
#1143
-1 'NEUTRAL NEUTRAL' 'TRUE NEUTRAL'~
True Neutral:

 

True Neutral Characters have committed themselves entirely to neutrality.

They do not see Good, Evil, Law, and Chaos as ideals to live by but as

extremes of every spectrum. Their actions, therefore, are not governed 

by these extremes and they seek to understand the world more through balance

and philosophy than by a predetermined notion of Good and Evil. True

Neutrals often take the side of the underdog in a conflict to maintain

a natural order. This is not to be confused with the Empire's understanding

of Order, but an order among all living beings within Aelisus. 

 

Druids are most commonly expected to follow True Neutrality as it is 

central to balance and maintaining the natural order that upholds the

protection of plants, animals and Nature itself. 
...
Lawful Evil characters often have a methodical and underhanded devotion

to a cruel and overly harsh system of Law designed for their own benefit.

They follow this law to the letter but twist it to their whims by 

dispensing justice without mercy and utilizing the protection the system

provides for their own gain. A Lawful Evil would not break the law

even when it is seemingly safe to do so, for fear of punishment, betrayal,

and angering the gods of Order and the Empire. Do not be certain this

means they have the best interests of everyone at heart, for outside of

cities governed by the Empire, they are prone to violently shedding their

guise of moral uprightness in sudden and unexpected displays of force.

Lawful Evils are entirely willing to use the laws of society to selfish

advantage. Corrupt politicians or petty thieves committing crimes on the

outskirts of town could be considered Lawful Evil.
...
Neutral Evils are ruthless pragmatists are their core. They hold no

interest for Law and Order but are happy to use either when it serves them.

They are completely self centered and live to exploit the weakness in

their enemies and even allies through cruelty and coercion. They do not

always actively seek to cause death and destruction, but often follow 

gods who deem these vices to be important and thus follow in turn. Hired

killers, priests of evil gods, and bandit highwaymen could all be considered

Neutral Evil. Their true concern is personal advancement without any

worry for the well being of others.
...
Chaotic Evil characters are often driven by extreme vice and find any

who would put a restriction on them an enemy and an affront to their cause. 

They are the scoundrels and murderers, the warlords and the wicked, the

curse and bane of society. Ruthless and brutal, they seek to endlessly 

acquire power in its rawest, purest form and only obey those who are 

capable of crushing them. True Chaotic Evils will not be content to 

serve for long, as it is their nature to betray and overthrow, to compete

in the eternal struggle to become the most powerful. Serial killers, demons,

and violent warlords are often Chaotic Evil. 
...
#1152
-1 'VALMIRAN CITY'~
A haven for all those good of heart,  is the bastion of the
...
Shasarazade.  Located past the rolling hills to the northeast of , it
...
#1155
-1 'AELISUS CITY'~
The dark port of the East.  Aelisus is a heavily populated and harsh

city located on the shores of the Dragon Sea.  Aelisus is home to a wide
...
Hidden deep below the sewers of Aelisus is a small community of
...
to the north of , it is among the oldest cities in all of Aelisus.  A
...
mountain of Aelisus, Mt. Khorand. Although physically isolated, it is 
...
#1159
-1 ' CITY'~
Nestled within the mountain ranges of central Aelisus,  is a nexus

of trade routes.  The largest and most prosperous city of Aelisus, it is

reknowned for its racial and religious tolerance.  The majority of all

adventurers hail from , due to its central location and its widely
...
northern reaches of Aelisus.  It is here that many ogres of Aelisus make
...
#1161
-1 'SHIRE CITY'~
Upon the western outskirts of  there is a humble community of

halflings.  Enjoying the wealth and safety of , they have been able
...
#1162
-1 'TARANDUE CITY'~
Within the rich grasslands south of , the gnomes of Aelisus have

made their home.  Tending to their pastures and village, they are a peaceful

people.  With such close proximity to , they enjoy an influx of
...
Aelisus allows you to choose detailed characterists such as build,
...
planes other then Aelisus. The Stalkers of Watcher have developed this
...
#1208
-1 bregyn~
In the early days of the first age of Aelisus, the people poured into
...
Certain races and beings in Aelisus communicate by broadcasting their
...
have effect on the reputation you hold with various races of Aelisus.
...
BLADEMASTER
  ...
  There are those fighters in the lands of Aelisus who swearing their
...
Syntax: stash purchase: purchase a locker
  ...
  The bank of Aelisus allow anyone to purchase and use a locker
...
Selling items in Aelisus is a wonderful idea, many an adventurer has prided themselves on holding the most coins in the land. But please be aware that selling within the city is generally frowned upon if you do not hold the proper permits since the city will not receive their due taxes from the transaction. In order to allow for an easier time selling items, the cities have set up a marketplace to use so that their taxes can be easily collected. 

See Also: Buy, Market, Morder
...
Buying items in Aelisus is highly encouraged, in order to better facilitate players buying/selling items a marketplace has been constructed that all players are free to use. Please note that this is only one way of procuring items from other players, as taking them from their corpse is always an option, although messier generally speaking.


See also: Morder, Market, Sell
...
While market orders can be created anywhere in the world, you may only place the order when you are in the room with the market. The following Syntax is how a player would create an order.


Morder create ---   Creates the order you wish to place

Morder Type <buy/sell> --- Sets the order as a purchase order or a sell order

Morder item <item> --- Sets the item you wish to purchase or sell

Morder item search <query> -- Lets you search the market for the item you want to buy, with a buy order. If you wish to purchase an item you need to search for its number here first. An example of this is

Morder item search boots--- Once you have found the boots you wish to purchase you can set that number as the item you would like. 

Morder item <number>  place the number of the item you found with search here for purchasing

Morder price <cost> This sets the price you wish to buy or sell the item for


Morder place – Places the order, keep in mind this command can only be used inside the market room. 
...
Here in Aelisus you are welcome to list various goods for others to purchase. You have several commands to assist you in this process. 

List  Will give you a list of items other players have posted with their order numbers

Buy <order number> Will confirm your purchase for the posted price

Sell	without an argument will give you a list of items the market will purchase from you

Sell <item>   Will sell the item if the market has a buy order for it. 


See also: Morder, Buy, Sell

~

#1266
-1 'attune' 'attunement' 'attuned' 'attuning'~
Syntax : attune <element> (example : attune fire)


Attuning to the elements is an old world magic that allows the crafter to

imbue powers to otherwise mundane items through concentration and "&ESSENCE"". 

There are six possible attunements in Aelisus, each needing to be learned in

one way or another.  Once learned, the crafter may attune different elements

at the same time before crafting in order to produced the desired power on

the item.  Some of the more desired effects may require attuning to five out

of six elements first.  After attuning to an element, you will innately know

what power will be placed on any item you craft.  Attuning to more than one

will change that power, in different combinations.  


NOTE : You can always check your attunement by checking your "&SCORE"" 

~

#1267
-1 'material' 'materials'~
Materials are raw items found in "&NODES"" around the world through

"&GATHERING"", purchased, or sometimes found on the dead.  Materials can then be

processed through "&CRAFTING"" to create a refined item that may then be sold,

consumed, or worn.  Raw materials can sometimes be used on their own. 

Herbs, for example, can be gathered and then "&SMOKED"".  Refined items, though,

will always hold a greater value and are highly sought after by crafters.  

~

#1268
-1 'FORAGE' 'FORAGING' 'FISHING' 'FISH' 'PRUNE' 'PRUNING' 'GATHER' 'GATHERING'~
Syntax : forage [node] / fish [node] / prune [node]


Gathering nodes are spread all throughout the wilds of Aelisus, waiting to

be exploited by the needy or those seeking profit.  Each node can be

gathered from in several ways.  


Foraging will allow you to search for food items from minerals, bushes, or

trees.  It can be used anywhere but always will result in better results at

nodes.  


Fishing, when on water or in front of a fishing node, will allow you to pull

different things from the depths.  Results may vary.  


Pruning only works on bushes, but lets you clip herbs that can then be

"&SMOKED"" or used to "&CRAFT"".  

~

#1269
-1 'cooking' 'cook' 'season' 'seasoning'~
Syntax: cook <recipe #> / season <seasoning> <food>


Cooking is easily one of the more profitable professions.  All of the items

you create will be consumed, and thus create a continuing demand.  Cooks can

take raw "&FOOD"" and create deliciously powerful products.  Cooks may "&ATTUNE""

themselves and cook any raw ingredient they know the "&RECIPE"" for to give it

desired properties.  To cook you must always be in front of a fire or oven. 


Seasoning is a secondary skill that is used after the cooked food is

finalized.  Seasoning increases the power of the food, duration, or
...
#1270
-1 'CRAFTING STATION' 'CRAFTING STATIONS'~
Crafting stations are places particular to the "&CRAFTING"" of items.  Each

profession has a specific crafting station.  For example, a "&COOK"" will need

to craft in front of a fire.  These crafting stations can be found in the

cities or in other places around the world.  
...
#1272
-1 'TOXIC' 'TOXICITY'~
Aelisus is a land that is permeated in magic and spiritualism.  Old world

magic comes from either the elements or communions with the higher plane. 

Still, there is also new magic that many have begun to tap into.  


New world magic was brought about by the rips in the fabric of the world

itself.  This type of sorcery is toxic, and the mortal frame can only take

so much of it before it begins to suffer.  Potions, and other consumables,

increase the toxicity in the system of the user.  


Toxicity is a limitation on the number of consumable items a mortal can use.

~

#1273
-1 assign~
Usage: assign <bag> <name>


Adventurers who would like to create a nickname for a container may do so

using the 'assign' command.  This will give the container a prefix with that
...
#1274
-1 spellpen maledpen afflpen mentalpen penetration pen 'spell penetration'~
SPELL PENETRATION SPELLPEN AFFLPEN MALEDPEN MENTALPEN


Spell Penetration is the antithesis of spell saves and can be broken down

into spellpen, maledpen, afflpen and mentalpen.  One penetration stat

negates a saves stat of the same kind.  For example, one spellpen would

reduce the target's saves vs spell by one while one afflpen would reduce the

target's saves vs afflictive by one.  
